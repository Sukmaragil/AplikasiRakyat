 ...
 */
public class AutoInsertEditText implements TextWatcher {
    ...
    public AutoInsertEditText(EditText editText, String appendText, int... position){
        this.mEditText = editText;
        this.mAppentText = appendText;
        this.mArray_pos = position.clone();
    }
    public AutoInsertEditText(EditText editText, String appendText, TextWatcher textWatcher, int... position){
